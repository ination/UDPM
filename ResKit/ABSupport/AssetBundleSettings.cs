...
namespace Project.Module.ResKit
{
    public class AssetBundleSettings
    {
        ...
        {
            string retName = null;
            string parren = ResFilePath.StreamingAssetsPath + "AssetBundles/" + GetPlatformName() + "/";
            retName = url.Replace(parren, "");

            parren = ResFilePath.PersistentDataPath + "AssetBundles/" + GetPlatformName() + "/";
        ...
        {
            string retUrl = ResFilePath.PersistentDataPath + "AssetBundles/" + GetPlatformName() + "/" + name;
            ...
            return ResFilePath.StreamingAssetsPath + "AssetBundles/" + GetPlatformName() + "/" + name;
        }
