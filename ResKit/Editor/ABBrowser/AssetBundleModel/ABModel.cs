...
namespace AssetBundleBrowser.AssetBundleModel
{
    ...
    public static class Model
    {
        ...
        static private void FindBundleIcons()
        {
            ...
            var iconRootPath = "Assets/Scripts/Module/ResKit/Editor/ABBrowser/Icons";
            s_bundleIcon = (Texture2D)AssetDatabase.LoadAssetAtPath(iconRootPath + "/ABundleBrowserIconY1756Basic.png", typeof(Texture2D));
            s_sceneIcon = (Texture2D)AssetDatabase.LoadAssetAtPath(iconRootPath + "/ABundleBrowserIconY1756Scene.png", typeof(Texture2D));
        }
    }
}
