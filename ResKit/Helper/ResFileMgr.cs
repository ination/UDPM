...
namespace Project.Module.ResKit
{
    ...
    public class ResFileMgr : Singleton<ResFileMgr>
	{
		...
		public ResFileMgr()
		{
			mSearchDirList.Add(ResFilePath.PersistentDataPath4Res);
			mStreamingAssetsPath = ResFilePath.StreamingAssetsPath;
		...
		public void GetFileInInner(string fileName, List<string> outResult)
		{
			...
			return;
#endif
			ResFilePath.GetFileInFolder(ResFilePath.StreamingAssetsPath, fileName, outResult); 
		}
